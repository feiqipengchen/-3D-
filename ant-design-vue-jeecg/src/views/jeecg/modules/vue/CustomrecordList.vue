  ...
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="完成">
                <a-input placeholder="请输入完成" v-model="queryParam.wancheng"></a-input>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div>
      ...
      <a-table
        ...
        <template slot="imgSl ot" slot-scope="text">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/custromrecord1/customrecord/list",
          delete: "/custromrecord1/customrecord/delete",
          deleteBatch: "/custromrecord1/customrecord/deleteBatch",
          exportXlsUrl: "/custromrecord1/customrecord/exportXls",
          importExcelUrl: "custromrecord1/customrecord/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'wancheng',text:'完成',dictCode:''})
