...
-->
        <a-form-model-item label="头像" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-image-upload class="avatar-uploader" text="上传" v-model="model.avatar"
                        ></j-image-upload>
        </a-form-model-item>
        ...
        <a-form-model-item label="性别" :labelCol="labelCol" :wrapperCol="wrapperCol" :readOnly="model.username!=getName()">
